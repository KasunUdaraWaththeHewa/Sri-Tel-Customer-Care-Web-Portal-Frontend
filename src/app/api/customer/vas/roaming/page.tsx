...
const RoamingActivation: React.FC = () => {
  // Example user details, assume this is fetched from the backend
  const [isRoamingActivated, setIsRoamingActivated] = useState(true); // User's roaming status
  ...
  const handleConfirm = () => {
    setIsRoamingActivated(action === "activate");
                ...
                <div className="text-left">
                    {isRoamingActivated ? (
                        <div className="flex flex-row text-center">
                            ...
                            <p className="ml-8 p-2 text-red-500 font-semibold">You have already activated Roaming. Click here if you want to deactivate it.</p>
                        </div>
